...
description: "get fastai running locally with GPU support"
date: "2022-12-19"
...
That's it. Now you can run fastai with GPU support locally simply by doing `mamba activate fastai` and launching _jupyter_ ! 💚
